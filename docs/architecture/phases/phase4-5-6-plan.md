...
class ImageRotationError(Exception):
    pass
...
1. ✗ `core/bidirectional_cache.py` (560行) - **确认后删除**
1. ✗ `core/unified_cache_manager.py` (595行) - **确认后删除**
1. ✗ `core/cache_interface.py` - **确认后删除**
1. ⚠️ `core/network_cache.py` (528行) - **检查网络功能**
