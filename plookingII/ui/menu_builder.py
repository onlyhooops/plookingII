...
from AppKit import NSEventModifierFlagCommand, NSMenu, NSMenuItem
...
class FileMenuBuilder:
    ...
    def build_file_menu(self) -> NSMenuItem:
        ...
        file_menu.setAutoenablesItems_(False)
...
class GoMenuBuilder:
    ...
    def build_go_menu(self) -> NSMenuItem:
        ...
        go_menu.setAutoenablesItems_(False)
...
class ViewMenuBuilder:
    ...
    def build_view_menu(self) -> NSMenuItem:
        ...
        view_menu.setAutoenablesItems_(False)
...
class ToolsMenuBuilder:
    ...
    def build_tools_menu(self) -> NSMenuItem:
        ...
        tools_menu.setAutoenablesItems_(False)
...
class HelpMenuBuilder:
    ...
    def build_help_menu(self) -> NSMenuItem:
        ...
        help_menu.setAutoenablesItems_(False)
