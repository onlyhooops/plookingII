...
class TestUIIntegration:
    ...
    def test_ui_controllers_import(self):
        """测试UI控制器导入"""
        try:
            from plookingII.ui.controllers import navigation_controller
            from plookingII.ui.controllers import image_view_controller
    ...
    def test_ui_managers_import(self):
        """测试UI管理器导入"""
        try:
            from plookingII.ui.managers import folder_manager
            from plookingII.ui.managers import image_manager
